...
const generateStatsItem = list => {
  ...
  return list.map(item => {
    ...
    <div className='Stats__row' key={item.type}>
      ...
      <div className={classnames('Stats__type', { 'Stats--active': types.active, 'Stats--resting': types.resting, 'Stats--inactive': types.inactive })}>
        {item.type}
      </div>
      <div className={classnames('Stats__progress', { 'Stats--active': types.active, 'Stats--resting': types.resting, 'Stats--inactive': types.inactive })}>
